...
for(i in seqq )
{
  ...
  par(mfrow=c(2,2))
  first.timeseries<-processFile(paste0("data_only_wrk/d_",i,"_scale_",d_factor,noise,"/opinions_",i,".txt"))
  ...
  first.timeseries<-processFile(paste0("data_only_wrk/d_",i,"_scale_",d_factor,noise,"/d_",i,"_sdev.txt"))
  # print(first.timeseries)
  ...
  first.timeseries<-processFile(paste0("data_only_wrk/d_",i,"_scale_",d_factor,noise,"/mean_overall_",i,".txt"))
  # print(first.timeseries)
  ...
  first.timeseries<-processFile(paste0("data_only_wrk/d_",i,"_scale_",d_factor,noise,"/means_",i,".txt"))
  # print(first.timeseries)
